...
date: "March 17, 2026"
tags: ["update"]
description: "A longer placeholder note for testing the single-note reading experience."
---

This is a longer placeholder note for testing how the single-note page behaves once there is enough reading depth to scroll through. I mainly want to see whether the ruler highlight feels stable while moving between the note header and the body content.

I also want to make sure the prose rhythm still feels right with **bold text**, *italic emphasis*, [a simple link](https://ankitmandal.tech), and a little bit of `inline code` inside a sentence.
